...
❌ **타겟 불명확** (Severity: Minor → -5점)
- "모든 고객", "누구나" 수준
- 구체적 페르소나 없음

❌ **채널 파편화** (Severity: Minor → -5점)
...
예시 1 (-5점):
"Critical: Red Flag 1건. Segment 9에서 '모든 고객을 위한 마케팅'이라 하여 타겟 불명확(-5점). 총 감점 -5점."

예시 2 (-15점):
"Critical: Red Flag 2건. (1) Segment 5에서 온라인과 오프라인 전략이 따로, 채널 파편화(-5점). (2) Segment 11에서 '마케팅 크게 성공'이라 했으나 결과 수치 없음(-10점). 총 감점 -15점."
...
[계산 예시]
Evidence: 82점, Weight 0.85 (Quote 3개)
Behavioral: 79점
Gap: -3 → Adjustment: 0.94
Adjusted: 82 × 0.85 × 0.94 = 65.5
Critical: -5점
Overall: 65.5 - 5 = 60.5 → 61점
...
{{
  ...
  "perspectives": {{
    ...
    "critical_reasoning": "Critical: Red Flag 1건. Segment 11에서 '모든 고객을 위한 이벤트'라고 하여 타겟 불명확(-5점). 총 감점 -5점."
  }},
  ...
  "calculation": {{
    ...
    "critical_penalties": -5,
    "final_score": 60.5,
    "formula": "82 × 0.85 × 0.94 - 5 = 60.5 → 61점"
  }},
...
7. "고객 중심 사고" > "마케팅 전문성" 우선순위를 유지하세요.
8. 타겟이 '모든 고객' 수준은 낮은 점수입니다.
9. 채널별 전략 없이 파편화되면 감점입니다.
"""
