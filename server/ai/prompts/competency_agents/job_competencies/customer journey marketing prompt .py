...
{{
  ...
  "suggested_followup_questions": [
    "20대 후반 직장인 여성이라는 타겟을 어떻게 정의하게 되었나요? 구체적인 분석 과정이 있었나요?",
    "매장 이벤트에서 고객 체험을 어떻게 설계하셨나요? VMD나 디스플레이 전략이 있었나요?",
    "구매 후 재구매를 유도하기 위해 어떤 전략을 사용하셨나요?"
  ]
}}
...
6. "고객 중심 사고" > "마케팅 전문성" 우선순위를 유지하세요.
7. 타겟이 '모든 고객' 수준은 낮은 점수입니다.
8. 채널별 전략 없이 파편화되면 감점입니다.
"""
